...
# What does the > operator mean?
  # Answer the value left to > is greater than the value right to the >

# Why are lines7, 9 and 11 indented?
  # Answer because they are inside the condition, 

# What is the purpose of this program?
  # Answer to execute true or false statement by stating conditions