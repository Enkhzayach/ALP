...
'''
weapon = ["knife", "sword", "nuclear bomb", "hydrogen bomb", "gun"]
 
zombiesWeakness = weapon[1]
print(zombiesWeakness)
print("Caution! Zombie has attacked our field, Please prepare for the fight")
print()
print("enter index of the weapon to use" )
index = int(input())
print(weapon[index])
if index == weapon[1]:
  print("you have won the fight yey!")
else:
